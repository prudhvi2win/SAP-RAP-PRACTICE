...
@EndUserText.label: 'Booking Supplements as child'
define view entity ZDEEPU_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZDEEPU_BOOKING as _Booking on
    $projection.BookingId = _Booking.BookingId and
    $projection.TravelId = _Booking.TravelId
association[1..1] to ZDEEPU_TRAVEL as _Travel on
